#!/bin/bash
#SBATCH -J mhd_ramp_coarse8_t9_25_t10_512p
#SBATCH -p standard
#SBATCH --nodes=1
...
# ============================================================================
# sequence: winner from coarse8_256p_t0_*;
# ----------------------------------------------------------------------------
# Replay the *fromWINNER* sweep winning ramp sequence on the t=370..401 /
# 512p (level2) window, coarse8 (data loss factor 8), WITHOUT activation
# checkpointing, into a new project and checkpoint dir.
#
...
# config/coarse8_t9_25_t10_512p.yaml for the phase table;
# train_params.epochs there is the full run length (2800).
#
# Same structure as run_ramping_512_t370_t401_noSweep_coarse8.sh (coarse8,
# data loss factor 8); only the ramp sequence (fromWINNER) and the ckpt/wandb
# names differ.
#
...
CONFIG_NAME=coarse8_t9_25_t10_512p
