#!/bin/bash
#SBATCH -J mhd_noPDE_stride8_t9_25_t10_512p
#SBATCH -p standard
#SBATCH --nodes=1
...
# ============================================================================
# noPDE control of run_ramping_stride8_t9_25_t10_512p.sh: the same
...
#   sbatch launchers_noPDE/run_stride8_t9_25_t10_512p_noPDE.sh
# ============================================================================
...
CONFIG_NAME=stride8_t9_25_t10_512p_noPDE
PARENT_NAME=stride8_t9_25_t10_512p
