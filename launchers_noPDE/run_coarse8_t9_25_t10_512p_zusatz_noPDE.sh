#!/bin/bash
#SBATCH -J mhd_noPDE_coarse8_t9_25_t10_512p_zusatz
#SBATCH -p standard
#SBATCH --nodes=1
...
# ============================================================================
# noPDE control of run_ramping_coarse8_t9_25_t10_512p_zusatz.sh: the
# same run (enlarged zusatz dataset), but the physics losses are NEVER
...
#   sbatch launchers_noPDE/run_coarse8_t9_25_t10_512p_zusatz_noPDE.sh
# ============================================================================
...
CONFIG_NAME=coarse8_t9_25_t10_512p_zusatz_noPDE
PARENT_NAME=coarse8_t9_25_t10_512p_zusatz
