#!/bin/bash
#SBATCH -J mhd_noPDE_stride8_t0_t2_5_256p
#SBATCH -p standard
#SBATCH --nodes=1
...
# ============================================================================
# noPDE control of run_ramping_stride8_t0_t2_5_256p.sh: the same run
# (smallMode FNO architecture), but the physics losses are NEVER switched on —
# pure data loss for all 600 epochs (the parent's data-only warm-up, continued
# to the end).
#
...
#   sbatch launchers_noPDE/run_stride8_t0_t2_5_256p_noPDE.sh
# ============================================================================
...
CONFIG_NAME=stride8_t0_t2_5_256p_noPDE
PARENT_NAME=stride8_t0_t2_5_256p
