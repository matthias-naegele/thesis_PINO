#!/bin/bash
#SBATCH -J mhd_noPDE_coarse8_t0_t2_5_256p
#SBATCH -p standard
#SBATCH --nodes=1
...
# ============================================================================
# noPDE control of run_ramping_coarse8_t0_t2_5_256p.sh: the same run,
# but the physics losses are NEVER switched on — pure data loss for all 600
# epochs (the parent's data-only warm-up, continued to the end).
#
...
#   sbatch launchers_noPDE/run_coarse8_t0_t2_5_256p_noPDE.sh
# ============================================================================
...
CONFIG_NAME=coarse8_t0_t2_5_256p_noPDE
PARENT_NAME=coarse8_t0_t2_5_256p
